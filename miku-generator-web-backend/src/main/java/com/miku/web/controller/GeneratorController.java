...
import com.miku.maker.meta.MetaValidator;
import com.miku.web.annotation.AuthCheck;
import com.miku.web.common.BaseResponse;
import com.miku.web.common.DeleteRequest;
import com.miku.web.common.ErrorCode;
import com.miku.web.common.ResultUtils;
import com.miku.web.constant.UserConstant;
import com.miku.web.exception.BusinessException;
import com.miku.web.exception.ThrowUtils;
import com.miku.web.manager.CacheManager;
import com.miku.web.manager.CosManager;
import com.miku.maker.meta.Meta;
import com.miku.web.model.dto.generator.*;
import com.miku.web.model.entity.Generator;
import com.miku.web.model.entity.User;
import com.miku.web.model.vo.GeneratorVO;
import com.miku.web.service.GeneratorService;
import com.miku.web.service.UserService;
...
public class GeneratorController {
    ...
    public BaseResponse<Page<GeneratorVO>> listGeneratorVOByPageFast(@RequestBody GeneratorQueryRequest generatorQueryRequest,
        ...
        long current = generatorQueryRequest.getCurrent();
        long size = generatorQueryRequest.getPageSize();
        String cacheKey = "v2" + getPageCacheKey(generatorQueryRequest);
     ...
     */
    @PostMapping("/user")
    public void usedGenerator(@RequestBody GeneratorUseRequest generatorUseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException{
        // 获取用户输入的请求参数
        ...
        // 执行脚本
        // 找到脚本文件所在路径
        // 要注意，如果不是 windows 系统，找 generator 文件而不是bat
