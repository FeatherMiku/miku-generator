package com.miku.web.vertx;

import cn.hutool.core.lang.TypeReference;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.miku.web.common.ResultUtils;
import com.miku.web.controller.GeneratorController;
                ...
                .requestHandler(req -> {
                    ...
                    if (HttpMethod.POST.equals(httpMethod) && "/generator/page".equals(path)) {
                        ...
                        req.handler(buffer -> {
                            ...
                            String cacheKey = "v2" + GeneratorController.getPageCacheKey(generatorQueryRequest);
