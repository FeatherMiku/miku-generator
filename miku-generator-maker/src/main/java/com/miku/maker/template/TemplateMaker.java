package com.miku.maker.template;
...
import com.miku.maker.meta.enums.FileGenerateTypeEnum;
import com.miku.maker.meta.enums.FileTypeEnum;
import com.miku.maker.template.enums.FileFilterRangeEnum;
import com.miku.maker.template.enums.FileFilterRuleEnum;
import com.miku.maker.template.model.FileFilterConfig;
import com.miku.maker.template.model.TemplateMakerConfig;
import com.miku.maker.template.model.TemplateMakerFileConfig;
import com.miku.maker.template.model.TemplateMakerModelConfig;
...
//        String searchStr = "Sum: ";
    ...
    private static List<Meta.ModelConfig.ModelInfo> distinctModels(List<Meta.ModelConfig.ModelInfo> modelInfoList) {
        ...
        // 4. 将未分组的模型添加到结果列表
        List<Meta.ModelConfig.ModelInfo> noGroupFileInfoList = modelInfoList.stream().filter(modelInfo -> StrUtil.isBlank(modelInfo.getGroupKey()))
                .collect(Collectors.toList());
